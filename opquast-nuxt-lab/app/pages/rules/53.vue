        ...
        <div class="p-6">
          ...
          <div v-if="activeTab === 'preview'" class="space-y-4">
            <div class="text-sm text-zinc-400">
              Exemple d'affichage clair des modalités de remboursement et
              d'annulation.
            </div>
            ...
            <div class="rounded-xl border border-zinc-800 bg-zinc-950 p-6">
              <div class="flex flex-col gap-6 sm:flex-row sm:justify-between">
                <div class="flex-1 space-y-3">
                  <div
                    class="flex items-center gap-2 text-zinc-100 font-medium"
                  >
                    <svg
                      width="20"
                      height="20"
                      class="h-5 w-5 text-zinc-500 shrink-0"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                  ...
                  <p class="text-sm text-zinc-400 leading-relaxed">
                    Effectués sur le moyen de paiement d'origine sous
                    <span class="text-zinc-200">5 à 10 jours ouvrés</span> après
                    réception de votre retour.
                  </p>
                </div>

                <div class="hidden w-px bg-zinc-800 sm:block"></div>
                ...
                <div class="flex-1 space-y-3">
                  ...
                  <p class="text-sm text-zinc-400 leading-relaxed">
                    Sans engagement. Vous pouvez annuler à tout moment depuis
                    votre
                    <a href="#" class="underline hover:text-zinc-200"
                      >Espace Client</a
                    >. L'arrêt est effectif à la fin du mois en cours.
                  </p>
                </div>
              </div>

              <div
                class="mt-6 flex gap-3 rounded-lg border border-blue-900/30 bg-blue-900/10 p-4"
              >
                <svg
                  width="20"
                  height="20"
                ...
                <div class="text-xs text-blue-200/80">
                  Conformément à l'article L221-18, vous disposez d'un délai de
                  14 jours pour exercer votre droit de rétractation sans avoir à
