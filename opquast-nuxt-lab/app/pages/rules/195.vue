        ...
        <div class="p-6">
          <div v-if="activeTab === 'preview'" class="space-y-4">
            <p class="text-zinc-300">
               Utilisez l'option "Imprimer" (Ctrl+P) de votre navigateur pour voir le rendu spécifique à l'impression si une feuille de style a été définie. <br>
               (Note : Le rendu ne peut pas être correctement simulé dans cet encart web).
            </p>
          </div>
          <div v-else>
...
<code>
@media print {
  /* Réinitialiser les couleurs pour le papier */
  body {
  ...
  .card, article {
    page-break-inside: avoid;
            ...
            <p class="mt-3 text-xs text-zinc-500">
              La media query <code>@media print</code> permet de définir des règles CSS qui ne s'appliqueront que lors de l'impression du document.
            </p>
          </div>
        </div>
      </div>
