...
const rule = {
  ...
  description: "Indiquer le poids du fichier permet à l'utilisateur de décider s'il peut le télécharger maintenant (connexion mobile) ou attendre d'être en Wifi.",
  tags: ["Basics", "Accessibilité", "Développement", "Écoconception"],
  authors: ["Gourrin Dimitri"],
  objective: "Informer préventivement l'utilisateur sur la quantité de données à télécharger et éviter les attentes frustrantes sur mobile.",
  implementationIntro: "L'information de poids doit être textuelle et visible :",
  implementation: [
    "Indiquer le poids dans le libellé du lien (ex: 'Brochure - 5 Mo').",
    "Pour les très petits fichiers (< 1 Mo), indiquer en Ko.",
    "Pour les gros fichiers, l'indiquer en Mo ou Go."
  ],
  control: [
    "Vérifier que chaque lien de téléchargement interne mentionne sa taille.",
    "S'assurer que l'unité est pertinente (Ko, Mo, Go)."
  ],
  screenshotsSources: [
    "Mauvais exemple (Pas de poids)",
    "Bon exemple (Poids indiqué)",
    "Code Source"
  ]
}
</script>
        ...
        <div class="p-6">
          <div v-if="activeTab === 'preview'" class="space-y-4">
            <div class="rounded-xl border border-zinc-800 bg-zinc-950 p-5 space-y-4">
              <div>
                <p class="text-xs text-red-400 mb-1">❌ Mauvais (Taille inconnue)</p>
                <a href="#" class="text-zinc-300 hover:text-white underline">Télécharger la vidéo de présentation</a>
              </div>
              
              <div class="pt-4 border-t border-zinc-800">
                <p class="text-xs text-green-400 mb-1">✅ Bon (Poids indiqué)</p>
                <a href="#" class="text-zinc-300 hover:text-white underline">
                  Vidéo de présentation <span class="text-zinc-500 text-xs">(MP4, 45 Mo)</span>
                </a>
              </div>

               <div class="pt-4 border-t border-zinc-800">
                <p class="text-xs text-green-400 mb-1">✅ Bon (Document léger)</p>
                <a href="#" class="text-zinc-300 hover:text-white underline">
                  Formulaire d'inscription (PDF, 200 Ko)
                </a>
              </div>
            </div>
          </div>
...
<code>&lt;!-- Mauvais --&gt;
&lt;a href="video.mp4"&gt;Voir la vidéo&lt;/a&gt;

&lt;!-- Bon --&gt;
&lt;a href="video.mp4"&gt;
  Voir la vidéo (MP4, 45 Mo)
&lt;/a&gt;

&lt;!-- Bon --&gt;
&lt;a href="form.pdf"&gt;
  Formulaire (PDF, 200 Ko)
&lt;/a&gt;</code></pre>
          </div>
        </div>
      </div>
