...
const rule = {
  id: 146,
  title: "L'utilisateur est averti des ouvertures de nouvelles fenêtres",
  description: "Si vous forcez l'ouverture d'un nouvel onglet, vous devez le dire explicitement pour ne pas perdre l'utilisateur.",
  tags: ["Accessibilité", "Liens", "UX"],
  authors: ["Gourrin Dimitri"],
  objective: "Éviter de désorienter les utilisateurs (surtout les malvoyants) en brisant l'historique de navigation.",
  implementationIntro: "Ajoutez une mention textuelle ou une icône avec infobulle.",
  implementation: [
    "Écrire '(nouvelle fenêtre)' dans le texte du lien.",
    "Utiliser l'attribut title='... (nouvelle fenêtre)' pour les liens courts.",
    "Ajouter une icône visuelle (carré avec flèche) indiquant la nouvelle fenêtre."
  ],
  control: [
    "Repérer les liens avec target='_blank'.",
    "Vérifier la présence de l'avertissement (texte ou title)."
  ],
  screenshotsSources: [
    "Mauvais exemple (Rien d'indiqué)",
    "Bon exemple (Texte explicite)",
    "Code Source"
  ]
}
</script>
        ...
        <div class="p-6">
          <div v-if="activeTab === 'preview'" class="space-y-4">
            <div class="rounded-xl border border-zinc-800 bg-zinc-950 p-5 space-y-4">
              <div>
                <p class="text-xs text-red-400 mb-1">❌ Mauvais (Aucune info)</p>
                <a href="#" target="_blank" class="text-zinc-300 hover:text-white underline">Mentions Légales</a>
              </div>
              
              <div class="pt-4 border-t border-zinc-800">
                <p class="text-xs text-green-400 mb-1">✅ Bon (Texte explicite)</p>
                <a href="#" target="_blank" class="text-zinc-300 hover:text-white underline">
                  Mentions Légales <span class="text-zinc-500 text-xs">(nouvelle fenêtre)</span>
                </a>
              </div>

               <div class="pt-4 border-t border-zinc-800">
                <p class="text-xs text-green-400 mb-1">✅ Bon (Icône + Infobulle)</p>
                <a href="#" target="_blank" title="CGV (nouvelle fenêtre)" class="text-zinc-300 hover:text-white underline flex items-center gap-1 w-fit">
                  CGV <span>❐</span>
                </a>
              </div>
            </div>
...
&lt;a href="cgv.html" target="_blank"&gt;
  CGV (nouvelle fenêtre)
&lt;/a&gt;

&lt;!-- Bon : Title + Icône --&gt;
&lt;a href="cgv.html" target="_blank" title="CGV (nouvelle fenêtre)"&gt;
  CGV ❐
&lt;/a&gt;</code></pre>
          </div>
        </div>
