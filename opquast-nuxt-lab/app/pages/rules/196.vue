        ...
        <div class="p-6">
          <div v-if="activeTab === 'preview'" class="space-y-4">
            <p class="text-zinc-300">
               Utilisez l'option "Imprimer" (Ctrl+P) de votre navigateur. Vous ne devriez pas voir la barre de navigation ou le menu latéral sur l'aperçu.
            </p>
          </div>
          <div v-else>
...
<code>
@media print {
  /* Masquer les éléments de navigation inutiles sur le papier */
  nav,
  header,
  footer,
  aside,
  .no-print {
    display: none !important;
             ...
             <p class="mt-3 text-xs text-zinc-500">
                Masquer la navigation permet d'économiser de l'encre et du papier tout en améliorant la lisibilité du contenu principal pertinent.
             </p>
          </div>
        </div>
      </div>
