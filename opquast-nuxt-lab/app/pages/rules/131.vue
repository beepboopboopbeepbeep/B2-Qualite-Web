      ...
      <div class="flex gap-4 overflow-x-auto pb-4 scrollbar-light">
        ...
        <div class="shrink-0 w-[280px] sm:w-[340px]">
          <div class="aspect-[16/10] rounded-2xl border border-green-900/30 bg-green-900/10 overflow-hidden flex items-center justify-center relative group">
            <a href="/screenshots/rule-131/SCREEN1.png" target="_blank" class="block cursor-zoom-in w-full h-full">
              <img src="/screenshots/rule-131/SCREEN1.png" alt="Bonne pratique" class="h-full w-full object-cover transition-transform group-hover:scale-105" />
            </a>
        ...
        <div class="shrink-0 w-[280px] sm:w-[340px]">
          <div class="aspect-[16/10] rounded-2xl border border-red-900/30 bg-red-900/10 overflow-hidden flex items-center justify-center relative group">
            <a href="/screenshots/rule-131/SCREEN2.png" target="_blank" class="block cursor-zoom-in w-full h-full">
              <img src="/screenshots/rule-131/SCREEN2.png" alt="Mauvaise pratique" class="h-full w-full object-cover transition-transform group-hover:scale-105" />
            </a>
        ...
        <div class="p-6">
          <div v-if="activeTab === 'preview'" class="space-y-6">
            <div class="text-sm text-zinc-400">
              Il est crucial d'avertir l'utilisateur si un lien mène vers un contenu dans une langue étrangère.
            </div>
            ...
            <div class="grid gap-6 md:grid-cols-2">
              ...
              <div class="rounded-xl border border-red-900/30 bg-red-950/5 p-5">
                <div class="flex items-center gap-2 mb-3 text-red-400">
                  ...
                  <span class="text-xs font-bold uppercase tracking-wide">Mauvaise pratique</span>
                </div>
                <p class="text-zinc-300 text-sm leading-relaxed">
                  Pour aller plus loin, lisez notre <a href="#" class="text-blue-400 hover:underline">analyse complète du malware</a>.
                </p>
                <p class="mt-2 text-xs text-zinc-500 italic">
                  (L'utilisateur clique et tombe sur un article en Russe sans avoir été prévenu).
                </p>
              </div>
              ...
              <div class="rounded-xl border border-green-900/30 bg-green-950/5 p-5">
                <div class="flex items-center gap-2 mb-3 text-green-400">
                  ...
                  <span class="text-xs font-bold uppercase tracking-wide">Bonne pratique</span>
                </div>
                <ul class="space-y-3 text-sm">
                  <li class="flex items-start gap-2 text-zinc-300">
                    <span>Source officielle :</span>
                    <a href="#" hreflang="en" class="text-blue-400 hover:underline inline-flex items-center">
                      NIST Cybersecurity Framework
                      <span class="ml-1.5 px-1.5 py-0.5 rounded border border-zinc-700 bg-zinc-800 text-[10px] text-zinc-400 font-mono no-underline" title="En anglais">EN</span>
                    </a>
                  </li>
                  <li class="flex items-start gap-2 text-zinc-300">
                    <span>Documentation :</span>
                    <a href="#" hreflang="de" class="text-blue-400 hover:underline inline-flex items-center">
                      BSI-Standards
                      <span class="ml-1.5 px-1.5 py-0.5 rounded border border-zinc-700 bg-zinc-800 text-[10px] text-zinc-400 font-mono no-underline" title="En allemand">DE</span>
                    </a>
                  </li>
                </ul>
              </div>
...
<code>&lt;!-- L'attribut hreflang indique la langue aux moteurs de recherche --&gt;
&lt;!-- L'élément visuel (span) indique la langue à l'utilisateur --&gt;

&lt;p&gt;
  Voir le rapport : 
  &lt;a href=&quot;report.pdf&quot; hreflang=&quot;en&quot;&gt;
    Annual Threat Analysis
    &lt;span class=&quot;lang-tag&quot; aria-label=&quot;en anglais&quot;&gt;(EN)&lt;/span&gt;
  &lt;/a&gt;
&lt;/p&gt;

&lt;style&gt;
/* Style discret pour l'indicateur de langue */
.lang-tag {
  font-size: 0.75rem;
